...
const covid19ImpactEstimator = (data) => {
  ...
  const impactVentilatorCases = Math.trunc(Math.floor((2 / 100) * impactInfectionsTime));
  const severeVentilatorCases = Math.trunc(Math.floor((2 / 100) * severeInfectionsTime));
